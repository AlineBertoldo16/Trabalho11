...
<body>
    <div class="container">
        <h2>Percentual de Gorjeta</h2>
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            Valor da Conta: <input type="number" name="valor_conta" min="0" step="0.01" required><br>
            Percentual de Gorjeta:
            <input type="radio" name="percentual_area" value="0.10" required> 10%
            <input type="radio" name="percentual_area" value="0.15"> 15%
            <input type="radio" name="percentual_area" value="0.20"> 20%<br>
            Área:
