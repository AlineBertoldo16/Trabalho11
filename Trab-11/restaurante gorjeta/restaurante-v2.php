...
<body>
    <div class="container">
		...
		$percentualGorjeta = $_POST['percentual_gorjeta'];
		$area = $_POST["area"];

		// Calculo do valor total com gorjeta
		$totalComGorjeta = $valorConta + ($valorConta * $percentualGorjeta);

		echo "<div class='resumo'>";
		echo "<p>Valor da conta: R$ ". number_format($valorConta, 2) . "</p>";
		echo "<p>Percentual de gorjeta: " . $percentualGorjeta*100 . "%</p>";
		echo "<p>Área: " . $area . "</p>";
		echo "<p>Total com gorjeta: R$ " . number_format($totalComGorjeta,  2) . "</p>";
		echo "</div>";
		...
		echo "</p>";
        echo "<p><strong>Valor da conta:</strong> R$ " . number_format($valorConta, 2, ',', '.') . "</p>";
        echo "<p><strong>totalComGorjeta:</strong> R$ " . number_format($totalComGorjeta, 2, ',', '.') . "</p>";
        echo "</div>";
		}	
    ?>
</body>
